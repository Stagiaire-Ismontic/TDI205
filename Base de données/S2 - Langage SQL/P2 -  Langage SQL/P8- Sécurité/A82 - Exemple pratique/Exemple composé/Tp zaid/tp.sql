...
grant update on Tache  to  Stagiare with grant option;
deny  update on Tache to  Stagiare cascade;
grant update,select,delete,insert on Tache to Stagiare;
revoke update,select,delete,insert on Tache to Stagiare;

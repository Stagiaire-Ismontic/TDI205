...
/* Constraint :permet de spécifier des règles pour les données d'une table.*/
/* check: spécifie les valeurs que peut prendre un attribut d’une relation */
/* Primary key : L’attribut (ou le groupe d’attributs) doit avoir une valeur unique et identifier un tuple de manière unique.*/

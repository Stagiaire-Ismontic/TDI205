...
namespace ClassConx
{
    public class GestionnaireStagiaires
    {
        ...
        public Stagiaire Recherche(int id)
        {
            ...
            dr.Read();
            Stagiaire s = new Stagiaire(dr.GetInt32(0), dr.GetString(1), dr.GetString(5));
            Connn.Close();
            return s;
        }
        ...
        public void Ajouter(Stagiaire s)
        {
            ...
            if (St != null)
            {
                string Req = "insert into Stagiaires (Id,Cin,Nom) Values(" + s.Id + ",'" + s.Cin + "','" + s.Nom + "')";
        ...
        public void Supprimer(int id)
        {
            ...
            Stagiaire St = new Stagiaire();
            St = this.Recherche(id);
            if (St != null)
            {
                string Req = "Delete from Stagiaire where Id=" + id;
                Connn.ExecuteSQL(Req);
            }
        ...
        public void Modifier(Stagiaire s)
        {
            ...
            if (St != null)
            {
                string Req = "Update Stagiaire set Nom = '" + s.Cin + "','" + s.Nom + "' where Id=" + s.Id;
                Connn.ExecuteSQL(Req);
            }

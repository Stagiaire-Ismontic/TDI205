...
namespace Tp2_datase
{
    public partial class Form1 : Form
    {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            CostumerAndOrders a = new CostumerAndOrders();
            new ordersTableAdapter().FillByName(a.orders,this.textBox2.Text);
            new costumersTableAdapter().Fill(a.costumers);
            dataGridView1.DataSource = a.orders.ToList<CostumerAndOrders.ordersRow>();
        }
    }
}

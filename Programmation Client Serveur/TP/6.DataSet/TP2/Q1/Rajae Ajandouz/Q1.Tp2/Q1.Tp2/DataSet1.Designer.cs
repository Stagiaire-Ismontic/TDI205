...
namespace Q1.Tp2.DataSet1TableAdapters {
...
SELECT id, Nom, Prenom, Adress FROM Employe WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Q1.Tp2.Properties.Settings.Default.EmployeConnectionString;
        }
        ...
        public virtual int Fill(DataSet1.EmployeDataTable dataTable) {
        ...
        public virtual DataSet1.EmployeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.EmployeDataTable dataTable = new DataSet1.EmployeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.EmployeDataTable dataTable) {
        ...
        internal void Insert(int p1, string p2, int p3)
        {

  ...
  public  class Gestion_Editeurs
    {
        ...
        public void Ajouter(Editeur E)
        {
          //  System.Windows.Forms.MessageBox.Show("Test");
            ListEdit.Add( new Editeur{Id=E.Id,  Nom=E.Nom,Categorie= E.Categorie,Id_livre= E.Id_livre} );
        ...
        {
            ListEdit.Where(c => c.Id == E.Id).Select(c => { c.Nom = E.Nom; c.Categorie = E.Categorie; c.Id_livre=E.Id_livre; return c; }).ToList();
        }

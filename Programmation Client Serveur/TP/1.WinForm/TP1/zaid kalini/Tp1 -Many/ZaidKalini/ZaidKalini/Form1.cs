...
namespace ZaidKalini
{
    public partial class Module : Form
    {
        ...
        private void txtSave_Click(object sender, EventArgs e)
        {
            if (etat == "Add")
            {
                service.Added(new BusnissLayer.Modules { id = service.GetId(), Nom_module = txtModule.Text });
            ...
            else
            {
                ...
                service.Update(new BusnissLayer.Modules { id = Convert.ToInt32(str), Nom_module = txtModule.Text });
                show();
